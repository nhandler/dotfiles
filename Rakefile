...
task :brew do
  ...
  `brew install ack git libtool imagemagick mysql postgres phantomjs pngcrush rbenv rbenv-gemset ruby-build tmux vim tree ssh-copy-id tig lynx reattach-to-user-namespace`
end
